...
export default function PricingPlans() {
  ...
  const handleSendWhatsApp = (e: React.FormEvent) => {
    ...
    const message = `Hola Heike Developer Hosting, mi nombre es ${formData.name}, mi correo es ${formData.email} y deseo contratar el Plan ${selectedPlan} por el precio anual de ${priceDisplay}.`;
